...
- [Opus Growth](https://mcp.opus-growth.com) - Hosted MCP connector to manage Google Ads, Meta Ads, Microsoft Advertising, TikTok Ads and LinkedIn Ads from Claude, ChatGPT and any MCP client. , real writes with dry-run approval gates, agency/MCC-safe, hosted OAuth.
